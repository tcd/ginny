...
class GinnyTest < Minitest::Test
  ...
  #   have = Ginny::Class.create(name: "Clay", description: "An awesome guy.").render()
  ...
  #   want = File.read(file_fixture("out/person_1.rb"))
  #   have = Ginny::Class.create(Ginny.load_json(file_fixture("in/person_1.json"))).render()
  #   assert_equal(want, have)
  # end

  # def test_attribute_constructor_from_json
  #   want = File.read(file_fixture("out/person_2.rb"))
  #   have = Ginny::Class.create(Ginny.load_json(file_fixture("in/person_2.json"))).render()
  #   assert_equal(want.strip, have.strip)
  # end

  # def test_class_constructor_from_yaml
  #   want = File.read(file_fixture("out/person_1.rb"))
  #   have = Ginny::Class.create(Ginny.load_yaml(file_fixture("in/person_1.yml"))).render()
  #   assert_equal(want, have)
  # end
